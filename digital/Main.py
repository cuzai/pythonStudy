...
# ---------------------------------------------------------------------------------
    ...
    def set_Kc_Title(self, title, href, date):
        ...
        try :
            ...
            self.kc_Li[self.kc_idx].clicked.connect(lambda: self.kcClicked(href))
            self.kc_idx += 1
        except Exception as e :
            logging.info("def kcSet_Title", e)
            pass
    ...
    def set_Kc_Internet_Title(self, title, href, date):
        logging.info("set_Kc_Internet_Title")
        try :
            self.kc_Li = [self.kc_Internet_Title1, self.kc_Internet_Title2, self.kc_Internet_Title3, self.kc_Internet_Title4, self.kc_Internet_Title5]
            self.kc_Date_Li = [self.kc_Internet_Date1, self.kc_Internet_Date2, self.kc_Internet_Date3, self.kc_Internet_Date4, self.kc_Internet_Date5]
            ...
            logging.info("def kcSet_InternetTitle : {}".format(e))
            pass
